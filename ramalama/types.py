"""Shared type definitions (protocols, dataclasses) for CLI/engine/store args."""
...
from ramalama.config.types import SUPPORTED_ENGINES, SUPPORTED_RUNTIMES, PathStr  # noqa: F401
